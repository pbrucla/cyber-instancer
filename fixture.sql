...
baby-sqli	Baby SQLI	Hey look it's a site that uses unescaped SQL surely this can't go wrong right???	{"containers": {"app": {"image": "docker.acmcyber.com/baby-sqli:latest", "ports": [8080]}}, "http": {"app": [[8080, "baby-sqli.egg.gnk.sh"]]}}	t	120	aplet123
\.
